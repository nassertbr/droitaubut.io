...
const floor1Material = new THREE.MeshStandardMaterial({ color: '#808000' })
const floor2Material = new THREE.MeshStandardMaterial({ color: '#556B2F' })
const obstacleMaterial = new THREE.MeshStandardMaterial({ color: '#d05252' })
...
{
    const goalgate = useGLTF('/goalgate.glb')

    goalgate.scene.children.forEach((mesh) =>
    {
    ...
    return <group position={ position }>
        ...
        <RigidBody type="fixed" colliders="hull" position={ [ 0, 0.25, 0 ] } restitution={ 0.2 } friction={ 0 }>
            <primitive object={ goalgate.scene } scale={ 0.2 } />
        </RigidBody>
    </group>
}
